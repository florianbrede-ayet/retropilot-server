...
CREATE TABLE public.athena_action_logs (
    ...
    meta json,
    created_at integer,
    dongle_id character varying(36)
);
...
CREATE TABLE public.devices (
    id integer NOT NULL,
    dongle_id character varying(36) NOT NULL,
    account_id integer,
    imei text,
    serial text,
    device_type text,
...
ALTER TABLE  ONLY public.drive_segments ADD CONSTRAINT drive_segments_unique_constraint UNIQUE (dongle_id, drive_identifier, segment_id);
